...
<div>
            ...
            <form action="addCommande_traitement.php" method="post">    
                <div>
                    <input type="text" name="num_commande" class="num_commande" placeholder="numéro de commande" required="required" autocomplete="off">
                </div>
                <div>
                    <input type="date" name="date" class="inser_date" placeholder="date" required="required" autocomplete="off">
                </div>
                <div>
                    <input type="text" name="referent" class="referent" placeholder="référent" required="required" autocomplete="off">
                </div>
                <div>
                    <input type="text" name="total_commande" class="total_commande" placeholder="total de la commande" required="required" autocomplete="off">
                </div>
                <div>
                    <input type="text" name="depot_total" class="depot_total" placeholder="depot total" required="required" autocomplete="off">
                </div>
                <div>
                    <input type="text" name="apayer" class="inser_apayer" placeholder="à payer" required="required" autocomplete="off">
                </div>
                <div>
                    <input type="text" name="points" class="inser_points" placeholder="points" required="required" autocomplete="off">
                </div>
                <div>
                    <input type="text" name="status" class="inser_status" placeholder="status" required="required" autocomplete="off">
                </div>
                <div>
                    <input type="text" name="num_mois" class="num_mois" placeholder="numéro dans le mois" required="required" autocomplete="off">
                </div>
                <div>
                    <input type="text" name="idClient" class="idClient" placeholder="id client" required="required" autocomplete="off">
                </div>
                <div>
